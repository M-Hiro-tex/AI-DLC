...
**CRITICAL**: When performing any phase, you MUST read and use relevant content from rule detail files in `.claude/aws-aidlc-rule-details/` directory.
...
1. Load the welcome message from `.claude/aws-aidlc-rule-details/common/welcome-message.md`
